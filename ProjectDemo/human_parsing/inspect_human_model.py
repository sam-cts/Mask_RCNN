...
import os
try:
	os.chdir(os.path.join(os.getcwd(), '../../Mask_RCNN/ProjectDemo/human_parsing'))
	print(os.getcwd())
except:
	pass
#%% [markdown]
# # Mask R-CNN - Inspect Human Parsing Trained Model
# 
...
from ProjectDemo.human_parsing import humanparsing
...
#%%
# Load validation dataset
dataset = humanparsing.HumanDataset()
dataset.load_human(HUMAN_DIR, "val")
